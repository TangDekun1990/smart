...
export default class BasicForms extends PureComponent {
  ...
  saveOrder = () => {
    ...
    fetch(URL + '/rawmaterial/addRawMaterial/v1', {
        method: 'post',
        mode: 'cors',
        body: formData
    }).then(function(res) {
...
//   formData.append('unitId', this.state.value5);
//   formData.append('remark', this.state.value6); 
//   fetch('/rawmaterial/addRawMaterial/v1', {
//       method: 'post',
//       mode: 'cors',
//       body: formData
//   }).then(function(res) {
...
handleChange6 = (contentState) => {
  this.setState({
    value6:  toString(contentState),
  });
}
 //返回
 goback=()=>{
  ...
  render() {
    ...
    <Breadcrumb.Item>新增原材料</Breadcrumb.Item>
  </Breadcrumb>
        <Card bordered={false}>
          <Form
