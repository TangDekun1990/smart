...
export default class AddWarn extends PureComponent {
  ...
  addSave = () => {
    ...
    fetch('/planproductalert/addPlanProductAlert/1', {
      method: 'post',
      mode: 'cors',
      body: formData
    }).then(function(res) {
          ...
          <Col md={8} sm={24}>
            <FormItem label="订单编号">
              {getFieldDecorator('no')(
                <Select placeholder="请选择" initialValue="0">
          ...
          <Col md={8} sm={24}>
            <FormItem>
              {getFieldDecorator('no5')(
                  ...
                  <Button icon="plus" type="primary" style={{ fontSize: 14 }}>
                  </Button>
              )}
            </FormItem>
          </Col>
