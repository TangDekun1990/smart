...
import {
  Form, Input, DatePicker, Select, Button, Card, InputNumber, Radio, Icon, Tooltip, Calendar,Breadcrumb
} from 'antd';
...
export default class BasicForms extends PureComponent {
    ...
    fetch( URL + '/deliveritem/getDeliverItemList/v1', {
        ...
        if (res.ok) {
            res.json().then(function (data) {
              if (data.code === "0") {
                that.setState({listShow: JSON.parse(data.data).deliveritemList[0]});
  ...
  //           res.json().then(function (data) {
  //             if (data.code === "0") {
  //               that.setState({listShow: data.data.deliveritemList[0]});
  ...
  doSave = () => {
    ...
    fetch(URL + '/deliveritem/updateDeliverItemById/v1', {
      method: 'post',
      mode: 'cors',
      body: formData
    }).then(function(res) {
  ...
  //   formData.append('remark', this.state.value7);
  //   formData.append('deliverTime', this.state.value8);
  //   fetch('/deliveritem/updateDeliverItemByDeliverItemId/v1', {
  //     method: 'post',
  //     mode: 'cors',
  //     body: formData
  //   }).then(function(res) {
 ...
 goback=()=>{
  ...
  render() {
    ...
    <Breadcrumb.Item href="#/deliver/list">发货列表</Breadcrumb.Item>
    <Breadcrumb.Item>更新发货</Breadcrumb.Item>
  </Breadcrumb>
        <Card bordered={false}>
          <Form
          ...
          >
            ...
            {/* <FormItem
              ...
              label="订单名称"
            >
             {getFieldDecorator('user2', { initialValue: this.state.listShow.orderName })(
            ...
            <FormItem
              ...
              label="物品类别"
            >
             {getFieldDecorator('user3', { initialValue: this.state.listShow.productCategoryName })(
            ...
            <FormItem
              ...
              label="物品单位"
            >
             {getFieldDecorator('user6', { initialValue: this.state.listShow.unitId })(
            ...
            >
             ...
             {getFieldDecorator('date', { initialValue: this.state.listShow.deliverTime })(
            ...
            <FormItem
              ...
              label="备注"
            >
            {getFieldDecorator('user8', { initialValue: this.state.listShow.remark })(
              <Input onChange={this.handleChange7} /> )}
